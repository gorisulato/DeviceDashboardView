...
namespace HartamaViewDashboard
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // CSS style (bootstrap/inspinia)d
            bundles.Add(new StyleBundle("~/Content/css").Include(
            ...
            //Icon Picker
            bundles.Add(new StyleBundle("~/Content/plugins/IconPicker").Include(
                        "~/Content/plugins/IconPicker/fontawesome-iconpicker.min.css"));

            // MapIcons
            bundles.Add(new StyleBundle("~/plugins/iconMaps").Include(
                      "~/Content/plugins/iconMaps/map-icons.css"));


            //Icon Picker Fontawesome
            bundles.Add(new StyleBundle("~/Content/plugins/IconPickerFontAwesome").Include(
                        "~/Content/plugins/IconPicker/font-awesome.css"));


            // Font Awesome icons
            bundles.Add(new StyleBundle("~/font-awesome/font-awesome-4.2.0/css").Include(
                      "~/fonts/font-awesome-4.2.0/css/font-awesome.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new ScriptBundle("~/plugins/jsPDF").Include(
                      ...
                      , "~/Scripts/plugins/jsPDF/jspdf.autotable.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                      ...
                      "~/Scripts/plugins/dataTables/fnFakeRowspan.js",
                      "~/Scripts/plugins/dataTables/dataTables.bootstrap.js",
                      "~/Scripts/plugins/dataTables/dataTables.responsive.js",
                      "~/Scripts/plugins/dataTables/dataTables.TableKey.Custom.js",
                      "~/Scripts/plugins/dataTables/dataTables.tableTools.min.js",
                      "~/Scripts/plugins/dataTables/jquery.spinner.js"
                      ));
            ...
            bundles.Add(new ScriptBundle("~/plugins/fullCalendar").Include(
                      ...
                      "~/Scripts/plugins/fullcalendar/jquery-paginate.min"));
            ...
            bundles.Add(new StyleBundle("~/plugins/dataPickerStyles").Include(
                      ...
                      "~/Content/plugins/datapicker/example.minimal.css",
                      "~/Content/plugins/datapicker/clockpicker.css",
                      "~/Content/plugins/datapicker/bootstrap-datetimepicker.min.css"));

            // dataPicker
            bundles.Add(new ScriptBundle("~/plugins/dataPicker").Include(
                      "~/Scripts/plugins/datapicker/bootstrap-datepicker.js",
                      "~/Scripts/plugins/datapicker/clockpicker.js",
                      "~/Scripts/plugins/datapicker/date.format.js",
                      "~/Scripts/plugins/datapicker/masking.js",
                      "~/Scripts/plugins/datapicker/jquery.inputmask.bundle.js",
                      "~/Scripts/plugins/datapicker/inputmask.js",
                      "~/Scripts/plugins/datapicker/inputmask.date.extension.js",
                      "~/Scripts/plugins/datapicker/bootstrap-datetimepicker.min.js"));
            ...
            // jsTree
            bundles.Add(new ScriptBundle("~/plugins/Tree").Include(
                      "~/Scripts/plugins/jsTree/jstree.min.js"));

            // jsTree styles
            bundles.Add(new StyleBundle("~/Content/plugins/Tree").Include(
                      "~/Content/plugins/jsTree/jstree.css"));
            ...
            // utility
            bundles.Add(new ScriptBundle("~/util").Include(
                    "~/Scripts/util/AssetApp.js",
                    "~/Scripts/util/jquery.simple.websocket.js",
                    "~/Scripts/util/jquery.websocket-0.0.1.js",
                    "~/Scripts/util/hideShowPassword.js",
                    "~/Scripts/util/jquery.hotkeys.js",
                    "~/Scripts/util/match-height.js",
                    "~/Scripts/util/map-icons.js",
                    "~/Scripts/util/jquery.maskMoney.js",
                    "~/Scripts/util/jquery-paginate.min.js",
                    "~/Scripts/util/autoNumeric.js"));


            // Tinycon
            bundles.Add(new ScriptBundle("~/plugins/tinycon").Include(
                      "~/Scripts/plugins/tinycon/tinycon.min.js"));
            //Add By Irham 8th Sept 2015
            //JS and Styles Icon Picker
            //IconPicker JS
            bundles.Add(new ScriptBundle("~/plugins/IconPicker").Include(
                      "~/Scripts/plugins/IconPicker/fontawesome-iconpicker.js"));

            //End Add By Irham 8th Sept 2015

            bundles.Add(new ScriptBundle("~/plugins/tooltips-master").Include(
                      "~/Scripts/plugins/tooltips-master/jquery.tooltipster.js"));

            bundles.Add(new StyleBundle("~/Content/plugins/jqueryspinner").Include(
                "~/Content/plugins/jqueryspinner/bootstrap-spinner.css"));

            bundles.Add(new ScriptBundle("~/plugins/jqueryspinner").Include(
                  "~/Scripts/plugins/jqueryspinner/jquery.spinner.js"));
            // QR Code builder
            bundles.Add(new ScriptBundle("~/plugins/qrcode").Include(
                      "~/Scripts/plugins/qrcode/jquery-qrcode-0.14.0.js",
                      "~/Scripts/plugins/qrcode/filereader.js",
                      "~/Scripts/plugins/qrcode/qrcodelib.js",
                       "~/Scripts/plugins/qrcode/webcodecamjs.js"
                      )
            );
            bundles.Add(new ScriptBundle("~/plugins/gauge").Include(
                      "~/Scripts/plugins/gauge/justgage.js",
                      "~/Scripts/plugins/gauge/raphael-2.1.4.min.js"
                      )
            );

            // TimeAgo chart
            bundles.Add(new ScriptBundle("~/plugins/timeAgo").Include(
                      "~/Scripts/plugins/timeAgo/timeAgo.js"));
        }
    }
}
